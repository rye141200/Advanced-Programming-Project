...
public class AdvancedProgrammingProject extends Application {
    @Override
    ...
    public static void Parse() throws Exception{
        ...
        File file = new File("C:\\Users\\hp\\OneDrive\\Desktop\\Advanced Programming project\\Advanced Programming Project\\src\\advanced\\programming\\project\\Example.mdl");
    ...
    public static int NumInputPorts_extraction(String line){
        ...
        return Integer.parseInt(arr[1].substring(0,end_index-1));
    }
    public static boolean Floating_extraction(String line){
        String[] arr = line.split(">");
        int end_index = arr[1].indexOf("<");
        if(arr[1].substring(0,end_index-1).matches("off"))
            return false;
        else
            return true;
    }
    ...
    public static double SampleTime_extraction(String line){
        String[] arr = line.split(">");
        int end_index = arr[1].indexOf("<");
        return Double.parseDouble(arr[1].substring(0,end_index-1));
    }
    ...
    public static double[] Points_extraction(String line){
        ...
        if(comma_count ==2){
            //four points
            String points_str = arr[1].substring(1,end_index-2);
